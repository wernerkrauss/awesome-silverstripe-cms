...
* [Masquerade](https://github.com/dhensby/silverstripe-masquerade) This module is designed to allow an Administrator to "login" as another "Member". This can be useful for debugging and remote support.
